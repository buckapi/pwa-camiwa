function initMap() {
  ...
  var imagePathsBase = "assets/camiwa/images/place/";

  // Check the direction attribute of the HTML element
  var dirAttribute = document.documentElement.getAttribute("dir");

  if (dirAttribute === "rtl") {
    imagePathsBase = "../assets/camiwa/images/place/";  // Update the base path for right-to-left
  }
  ...
  var iconBase = "assets/camiwa/images/icon/";

  // Check the direction attribute of the HTML element
  var dirAttribute = document.documentElement.getAttribute("dir");

  if (dirAttribute === "rtl") {
    iconBase = "../assets/camiwa/images/icon/";  // Update the base path for right-to-left
  }
