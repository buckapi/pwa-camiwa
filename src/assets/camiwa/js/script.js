...
document.addEventListener('DOMContentLoaded', function () {
    ...
    themeToggleBtn.addEventListener('click', function () {
        ...
        if (htmlElement.getAttribute('data-bs-theme') === 'dark') {
            ...
            localStorage.setItem('imagePath', 'assets/camiwa/images/lines.svg'); // Store the theme preference in localStorage
        } else {
            ...
            localStorage.setItem('imagePath', 'assets/camiwa/images/lines-2.svg'); // Store the theme preference in localStorage
        }
    });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    bgImageElements.forEach(function (bgImageElement) {
        ...
        if (bgImageElement) {
            var currentImagePath = localStorage.getItem('imagePath') || 'assets/camiwa/images/lines.svg';
            ...
            document.getElementById('themeToggleBtn').addEventListener('click', function () {
                ...
                if (currentImagePath === 'assets/camiwa/images/lines.svg') {
                    newImagePath = 'assets/camiwa/images/lines-2.svg'; // Change this to the new path
                } else {
                    newImagePath = 'assets/camiwa/images/lines.svg';
                }
